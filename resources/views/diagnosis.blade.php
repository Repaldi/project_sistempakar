        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-12 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Halaman Diagnosis</h6>
            </div>
          </div>
          <div class="alert  alert-success alert-dismissible fade show" role="alert">
                <span class="alert-icon"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></span>
                <span class="alert-text"><strong>Perhatian !</strong> </span>
                <span class="alert-text">Silahkan memilih gejala sesuai dengan kondisi nanas anda, anda dapat memilih kepastian kondisi nanas dari pasti tidak hingga pasti ya, jika telah selesai memilih silahkan tekan tombol (<i class="fa fa-search-plus" aria-hidden="true"></i>) proses.
                </span>
            </div>  
        </div>
      </div>
          ...
          <table class="table align-items-center table-flush table-striped">
            ...
            @foreach($gejala as $item)
              <tr>
                ...
                <td>
                <span class="font-weight-bold">{{$item->kode_gejala}}</span>
                </td>
                <td>
            ...
            <tr>
                <td colspan='4'>
                    <div class="alert  alert-warning alert-dismissible fade show" role="alert">
                        <span class="alert-icon"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i></span>
                            <span class="alert-text"><strong>MAAF !</strong> </span>
                            <span class="alert-text">Saat ini belum ada gejala yang tersedia</span>
                        </span>
                    </div>   
                </td>
            </tr>
